...
(select 
	...
	source_town.bfs_nr as source_town_bfs_nr,
...
from 
	...
	join sbb_station as source_sbb_station on source_sbb_station.id = source_town.closest_station_id
	join sbb_station as target_sbb_station on target_sbb_station.id = target_town.closest_station_id
where
